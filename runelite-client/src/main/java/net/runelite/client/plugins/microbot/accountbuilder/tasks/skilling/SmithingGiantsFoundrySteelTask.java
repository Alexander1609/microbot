...
public class SmithingGiantsFoundrySteelTask extends AccountBuilderTask {
    GiantsFoundryScript giantsFoundryScript = new GiantsFoundryScript();

    @Override
    public String getName() {
        return "Smithing: Giants foundry (Iron/Steel)";
    }

    public SmithingGiantsFoundrySteelTask(){
        ...
        addRequirement(ItemID.IRON_BAR, 300);
    }
